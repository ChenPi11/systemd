...
static void test_exec_bindpaths(Manager *m) {
        ...
        ASSERT_OK(mkdir_p(SYSTEM_TMPDIR "/test-exec-bindpaths source", 0755));
        ASSERT_OK(mkdir_p(SYSTEM_TMPDIR "/test-exec-bindpaths destination", 0755));
        ASSERT_OK(mkdir_p(SYSTEM_TMPDIR "/test-exec-bindpaths:source", 0755));
        ASSERT_OK(mkdir_p(SYSTEM_TMPDIR "/test-exec-bindpaths:destination", 0755));
        ASSERT_OK(mkdir_p(SYSTEM_TMPDIR "/test-exec-bindreadonlypaths source", 0755));
        ASSERT_OK(mkdir_p(SYSTEM_TMPDIR "/test-exec-bindreadonlypaths destination", 0755));
        ASSERT_OK(mkdir_p(SYSTEM_TMPDIR "/test-exec-bindreadonlypaths:source", 0755));
        ASSERT_OK(mkdir_p(SYSTEM_TMPDIR "/test-exec-bindreadonlypaths:destination", 0755));
        ...
        (void) rm_rf(SYSTEM_TMPDIR "/test-exec-bindpaths source", REMOVE_ROOT|REMOVE_PHYSICAL);
        (void) rm_rf(SYSTEM_TMPDIR "/test-exec-bindpaths destination", REMOVE_ROOT|REMOVE_PHYSICAL);
        (void) rm_rf(SYSTEM_TMPDIR "/test-exec-bindpaths:source", REMOVE_ROOT|REMOVE_PHYSICAL);
        (void) rm_rf(SYSTEM_TMPDIR "/test-exec-bindpaths:destination", REMOVE_ROOT|REMOVE_PHYSICAL);
        (void) rm_rf(SYSTEM_TMPDIR "/test-exec-bindreadonlypaths source", REMOVE_ROOT|REMOVE_PHYSICAL);
        (void) rm_rf(SYSTEM_TMPDIR "/test-exec-bindreadonlypaths destination", REMOVE_ROOT|REMOVE_PHYSICAL);
        (void) rm_rf(SYSTEM_TMPDIR "/test-exec-bindreadonlypaths:source", REMOVE_ROOT|REMOVE_PHYSICAL);
        (void) rm_rf(SYSTEM_TMPDIR "/test-exec-bindreadonlypaths:destination", REMOVE_ROOT|REMOVE_PHYSICAL);
}
