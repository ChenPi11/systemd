...
static int generate_clone_units(
        ...
        _cleanup_free_ char *clone_name_spec_escaped = NULL;
        ...
        _cleanup_free_ char *clone_dev_path = NULL, *clone_dev_path_escaped = NULL,
        ...
        _cleanup_free_ char *source_spec_escaped = NULL,
        ...
        fprintf(f,
                ...
                clone_name_spec_escaped, source_spec_escaped, dest_spec_escaped,
                metadata_spec_escaped, options_spec_escaped ?: "-");
...
static int add_clone_devices(void) {
        ...
        for (;;) {
                _cleanup_free_ char *line = NULL, *src = NULL,
                               *name = NULL, *dst = NULL, *meta = NULL, *options = NULL;
                int k;
                ...
                if (k < 4 || k > 5) {
                        log_warning("Failed to parse %s:%u, ignoring.", fname, clone_line);
                        continue;
                }

                log_debug("Processing %s:%u", fname, clone_line);
