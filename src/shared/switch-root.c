...
int switch_root(const char *new_root,
        ...
        static const struct {
                ...
                { RUNSTATEDIR,             MS_BIND,         MS_BIND|MS_REC }, /* Recursive except on soft reboot, see above */
                { RUNSTATEDIR "/credentials", MS_BIND|MS_REC,  0 /* skip! */  }, /* Credential mounts should survive */
                { RUNSTATEDIR "/host",        MS_BIND|MS_REC,  0 /* skip! */  }, /* Host supplied hierarchy should also survive */
        };
