...
/* explicit_bzero() is only declared in bionic's string.h from Android API level 17 onwards.
 * Provide a fallback inline implementation using a compiler barrier to prevent the compiler
