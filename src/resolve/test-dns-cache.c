...
TEST(dns_cache_dump_single_a) {
        ...
        _cleanup_(unlink_tempfilep) char p[] = SYSTEM_TMPDIR "/dns-cache-dump-single-a-XXXXXX";
...
TEST(dns_cache_dump_a_with_cname) {
        ...
        _cleanup_(unlink_tempfilep) char p[] = SYSTEM_TMPDIR "/dns-cache-dump-a-with-cname-XXXXXX";
        _cleanup_fclose_ FILE *f = NULL;
        fmkostemp_safe(p, "r+", &f);
        dns_cache_dump(&cache, f);
